...
TEAM_DOMESTIC_LEAGUE = {
    ...
    # Spanish teams (La Liga)
    "mallorca": "esp.1",          "rcd mallorca": "esp.1",
    "valencia": "esp.1",          "valencia cf": "esp.1",
    "sevilla": "esp.1",           "sevilla fc": "esp.1",
    "real sociedad": "esp.1",     "sociedad": "esp.1",
    "girona": "esp.1",            "girona fc": "esp.1",
    "osasuna": "esp.1",           "ca osasuna": "esp.1",
    "rayo vallecano": "esp.1",    "rayo": "esp.1",
    "espanyol": "esp.1",          "rcd espanyol": "esp.1",
    "alaves": "esp.1",            "deportivo alaves": "esp.1",
    "getafe": "esp.1",            "getafe cf": "esp.1",
    "elche": "esp.1",
    "real oviedo": "esp.1",
    # Italian teams
